            ...
            <div id="alpha-section" class="row align-items-start g-5 mb-5 min-vh-100">
                ...
                <div class="skill-section col-lg-6">
                    ...
                    <div class="lc-block mb-4">
                        ...
                        <div class="progress" role="progressbar" aria-label="Animated striped example"
                            ...
                            <div class="progress-bar react-animation progress-bar-striped" style="width: 90%">90%</div>
                        </div>
                    </div>
                    ...
                    <div class="lc-block mb-4">
                        ...
                        <div class="progress" role="progressbar" aria-label="Animated striped example"
                            aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="height: 20px;">
                            <div class="progress-bar bootstrap-animation progress-bar-striped" style="width: 80%">80%
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lc-block mb-4">
                        ...
                        <div class="progress" role="progressbar" aria-label="Animated striped example"
                            aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="height: 20px;">
                            <div class="progress-bar flutter-animation progress-bar-striped" style="width: 50%">50%</div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="lc-block mb-4">
                        ...
                        <div class="progress" role="progressbar" aria-label="Animated striped example"
                            aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="height: 20px;">
                            <div class="progress-bar laravel-animation progress-bar-striped" style="width: 60%">60%</div>
                        </div>
                    </div>
                    ...
                    <div class="lc-block mb-4">
                        ...
                        <div class="progress" role="progressbar" aria-label="Animated striped example"
                            aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="height: 20px;">
                            <div class="progress-bar laravel-animation progress-bar-striped" style="width: 80%">80%</div>
                        </div>
                    </div>
                    ...
                    <div class="lc-block mb-4">
                        ...
                        <div class="progress" role="progressbar" aria-label="Animated striped example"
                            aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="height: 20px;">
                            <div class="progress-bar laravel-animation progress-bar-striped" style="width: 70%">70%</div>
                        </div>
                    </div>
                    ...
                    <div class="lc-block mb-4">
                        ...
                        <div class="progress" role="progressbar" aria-label="Animated striped example"
                            aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="height: 20px;">
                            <div class="progress-bar python-animation progress-bar-striped" style="width: 80%">80%</div>
                        </div>
                    </div>
